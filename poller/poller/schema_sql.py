"""Canonical SQLite DDL (§7) — Python mirror of web/src/db/ddl.ts.

⚠️ Keep IDENTICAL to web/src/db/ddl.ts (column names + types). Both apply
CREATE TABLE IF NOT EXISTS so either side can initialize the shared DB.
